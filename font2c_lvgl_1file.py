...
class LVGLFontConverterApp:
    def __init__(self, root):
        self.root = root
        self.root.title("TTF to LVGL C Font Converter")
        ...
        self.browse_btn = tk.Button(root, text="Browse Font File", command=self.browse_file)
        self.browse_btn.pack(pady=5)

        self.convert_btn = tk.Button(root, text="Generate LVGL .c Font File", command=self.convert_font)
    ...
    def convert_font(self):
        ...
        try:
            ...
            self.status.config(text=f"Success! Generated file: {output_path}")
            messagebox.showinfo("Done", f"LVGL font file generated:\n{output_path}")
    ...
    def generate_lvgl_font_c(self, font_path):
        ...
        # Get unique output filename to avoid overwrite
